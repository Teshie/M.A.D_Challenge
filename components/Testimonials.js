...
const Testimonials = () => {
  return (
    <div className="">
      <header className="relative w-full h-[60rem] bg-[url('https://i.pinimg.com/originals/4e/80/76/4e8076838b1e96e81f9312bee41b188f.jpg')] bg-cover bg-center flex justify-center items-center">
        ...
        <div className="flex mt-10 flex-col justify-center items-center">
          ...
          <p className="mt-10 text-center text-xl text-white opacity-100">
            ...
            <span className="text-green-600 mx-1">FINAL ADMISSION</span>
          </p>
